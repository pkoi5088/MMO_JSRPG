...
public class UI_Stat : UI_Base
{
    ...
    public void RefreshUI()
    {
        ...
        foreach(Item item in Managers.Inven.Items.Values)
        {
            ...
            Sprite _icon = Managers.Resource.Load<Sprite>(itemData.iconPath);

            if (item.ItemType == ItemType.Weapon)
            {
                Get<Image>((int)Images.Slot_Weapon).enabled = true;
                Get<Image>((int)Images.Slot_Weapon).sprite = _icon;
            }
            else if (item.ItemType == ItemType.Armor)
            {
                ...
                switch (armor.ArmorType)
                {
                    case ArmorType.Helmet:
                        ...
                        Get<Image>((int)Images.Slot_Helmet).sprite = _icon;
                        break;
                    case ArmorType.Armor:
                        Get<Image>((int)Images.Slot_Armor).enabled = true;
                        Get<Image>((int)Images.Slot_Armor).sprite = _icon;
                        break;
                    case ArmorType.Boots:
                        Get<Image>((int)Images.Slot_Boots).enabled = true;
                        Get<Image>((int)Images.Slot_Boots).sprite = _icon;
                        break;
                }
            }
        }
